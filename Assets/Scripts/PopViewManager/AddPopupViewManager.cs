...
public class AddPopupViewManager : PopupViewManager
{
    ...
    {
        AddPhotoPopupViewManager addPohotoPopViewManager = Instantiate(addPhotoPopupViewPrefab, this.gameObject.transform.parent).GetComponent<AddPhotoPopupViewManager>();
        addPohotoPopViewManager.Open(AnimationType.TYPE2);
        addPohotoPopViewManager.addPopupViewManager = this;
        addPohotoPopViewManager.sprite = GetIcon;     
    }

    public void GetIcon(Sprite sp)
    {
        iconImage.sprite = sp;
    }
}
